...
# Clean up all sources and tests
shutil.rmtree('Sources', ignore_errors=True)
shutil.rmtree('Tests', ignore_errors=True)

# Generate Core
generate_core_src = """import Foundation

public enum LogLevel: Int { case debug, info, warning, error }
...
"""
write_file("Sources/ToolkitCore/CoreSDK.swift", generate_core_src)

# Generate Utility
generate_util_src = """import Foundation
import Combine
import ToolkitCore
...
public class ToolkitUtilityManager: BaseManager {
    public static let shared = ToolkitUtilityManager()
...
"""
write_file("Sources/ToolkitUtility/ToolkitUtilityManager.swift", generate_util_src)

# Generate Crypto
generate_crypto_src = """import Foundation
import CryptoKit
import ToolkitCore
...
public class ToolkitCryptoManager: BaseManager {
    public static let shared = ToolkitCryptoManager()
...
"""
write_file("Sources/ToolkitCrypto/ToolkitCryptoManager.swift", generate_crypto_src)

# Generate Networking
generate_net_src = """import Foundation
import ToolkitCore
import Alamofire
...
public class ToolkitNetworkingManager: BaseManager {
    public static let shared = ToolkitNetworkingManager()
...
"""
write_file("Sources/ToolkitNetworking/ToolkitNetworkingManager.swift", generate_net_src)

# Generate Auth
generate_auth_src = """import Foundation
import ToolkitCore
...
public class ToolkitAuthManager: BaseManager, BaseNetworkInterceptor {
...
"""
write_file("Sources/ToolkitAuth/ToolkitAuthManager.swift", generate_auth_src)

# Generate Compression
generate_comp_src = """import Foundation
import ToolkitCore
...
"""
write_file("Sources/ToolkitCompression/ToolkitCompressionManager.swift", generate_comp_src)
...
public struct ToolkitUI {
    public static func configure() {
        Logger.shared.log("ToolkitUI configured", level: .info, file: #file, function: #function, line: #line)
    }
}
...
public struct LoginView: View {
    ...
    public var body: some View {
        VStack {
            ...
            Button("Login") {
                Task {
                    try? await ToolkitAuthManager.shared.authenticate(method: .username)
                }
            }
            .padding()
        }
...
"""
write_file("Tests/ToolkitUITests/UITests.swift", ui_test)
...
"""
write_file("Tests/ToolkitPluginsTests/PluginTests.swift", plug_test)

all_test = """import XCTest
@testable import ToolkitAll
final class AllTests: XCTestCase {
    func testIntegration() {
        XCTAssertNotNil(ToolkitUtilityManager.shared)
        XCTAssertNotNil(ToolkitNetworkingManager.shared)
    }
}
"""
write_file("Tests/ToolkitAllTests/AllTests.swift", all_test)
